/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e51fc190657bc748bfb2fedee933df83)
// Runtime types generated with workerd@1.20250523.0 2025-04-01 
declare namespace Cloudflare {
	interface Env {
		YATCC: KVNamespace;
		BOT_INFO: {"id":7618804505,"is_bot":true,"first_name":"YA Tree Context Chat Bot","username":"yatccbot","can_join_groups":true,"can_read_all_group_messages":false,"supports_inline_queries":false,"can_connect_to_business":false,"has_main_web_app":false};
		BOT_TOKEN: string;
		secret_token: string;
